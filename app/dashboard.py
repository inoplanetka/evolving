...
from streamlit_prophet.lib.exposition.export import display_save_experiment_button # display_links, 
...
# Page config
st.set_page_config(page_title="Esgian Prophet", layout="wide")
...
# Info
with st.expander("Welcome to the prediction app! So, how does our app work?", expanded=False):
    st.write(readme["app"]["app_intro"])
    st.write("")
st.write("")
st.sidebar.image(load_image("new_logo.png"), use_column_width=True)

###### Take a photo


col_photo, col_photo2, col_photo3 = st.columns(3)
with col_photo:
   st.camera_input("Take a picture!", help = "Take an image of something you might need along the way, this supports virtual cameras")
